...
| Layer | Technology |
|---|---|
| Frontend | React, Axios — deployed on Vercel |
...
- **Fully deployed** — live on Vercel + Render + Neon, accessible from anywhere
...
|---|---|---|
| Database | Neon (free tier) | PostgreSQL hosting |
...
- How to deploy a full-stack app using Vercel + Render + Neon for free
